...
class PaymentSlipTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::__construct()
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::getCart()
     */
     ...
     * @test
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::__construct()
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::setCart()
     */
     ...
     * @test
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::__construct()
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::save()
     */
     ...
     * @test
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::__construct()
     * @covers \MrPrompt\CaixaEconomicaFederal\Shipment\PaymentSlip::read()
     */
